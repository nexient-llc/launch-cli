...
def test_git_clone_failure():
    with patch('launch.automation.common.functions.git.Repo.clone_from', side_effect=git.GitCommandError("clone", "error")):
        target_dir = "target/directory"
        clone_url = "https://github.com/example/repo.git"
...
def test_git_clone_skipped_failure():
    with patch('launch.automation.common.functions.git.Repo', side_effect=git.GitCommandError("get", "error")):
        target_dir = "target/directory"
        clone_url = "https://github.com/example/repo.git"
